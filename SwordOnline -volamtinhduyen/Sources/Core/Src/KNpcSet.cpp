...
void KNpcSet::CheckBalance()
{
	...
	while(nIdx)
	{
		...
		if (SubWorld[0].m_dwCurrentTime - Npc[nIdx].m_SyncSignal > 1000)
		{
			...
			if (Npc[Player[CLIENT_PLAYER_INDEX].m_nIndex].m_SyncSignal - Npc[nIdx].m_SyncSignal > 3*18 && Npc[nIdx].m_Kind == kind_player)//Fix lag toa do
			{
			...
			else if (Npc[Player[CLIENT_PLAYER_INDEX].m_nIndex].m_SyncSignal - Npc[nIdx].m_SyncSignal > 5*18 && Npc[nIdx].m_TypeNpc == 0)
			{
				if (Npc[nIdx].m_RegionIndex >= 0)
				{
					SubWorld[0].m_Region[Npc[nIdx].m_RegionIndex].RemoveNpc(nIdx);
...
NPC_RELATION KNpcSet::GetRelation(int nId1, int nId2)
{
	...
	else if (Player[CLIENT_PLAYER_INDEX].m_nIndex == nId1)
	{
		...
		if (Npc[nId2].m_Kind == kind_player && Npc[nId2].m_PKValue == MAX_DEATH_PUNISH_PK_VALUE && Npc[nId2].m_CurrentCamp != 0 && Npc[nId1].m_CurrentCamp != 0 && Npc[nId1].m_CurrentCamp != Npc[nId2].m_CurrentCamp)
		return relation_enemy;
			...
			Npc[nId2].m_nPKFlag == 2 &&
			Npc[nId1].m_FightMode && Npc[nId2].m_FightMode && 
			Npc[nId2].m_CurrentCamp != Npc[nId1].m_CurrentCamp && 
			Npc[nId2].m_CurrentCamp != 0 && Npc[nId1].m_CurrentCamp != 0&&
			(Map == 93 || Map == 99 || Map == 94 || Map == 100 || Map == 109 || Map == 110 || Map == 111 || Map == 79 || Map == 20) )
			{
				return relation_enemy;
			}
	...
	else	// if (Player[CLIENT_PLAYER_INDEX].m_nIndex == nId2)
	{
		...
		if (Npc[nId1].m_Kind == kind_player && Npc[nId1].m_PKValue == MAX_DEATH_PUNISH_PK_VALUE && Npc[nId2].m_CurrentCamp != 0 && Npc[nId1].m_CurrentCamp != 0 && Npc[nId1].m_CurrentCamp != Npc[nId2].m_CurrentCamp)
		return relation_enemy;
		
			if (Npc[nId1].m_Kind == kind_player && 
			(Player[CLIENT_PLAYER_INDEX].m_cPK.GetNormalPKState() == 2  ||
			 Player[CLIENT_PLAYER_INDEX].m_cPK.GetNormalPKState() == 1 && Npc[nId1].m_nPKFlag != 0) &&
			Npc[nId1].m_FightMode && Npc[nId2].m_FightMode && 
			Npc[nId2].m_CurrentCamp != Npc[nId1].m_CurrentCamp && 
			Npc[nId2].m_CurrentCamp != 0 && Npc[nId1].m_CurrentCamp != 0)
			{
	...
	else
	{
		...
		if (Npc[nId2].m_Kind == kind_player && Player[Npc[nId2].m_nPlayerIdx].m_cPK.GetPKValue() == MAX_DEATH_PUNISH_PK_VALUE && Npc[nId2].m_CurrentCamp != 0 && Npc[nId1].m_CurrentCamp != 0 && Npc[nId2].m_CurrentCamp != Npc[nId1].m_CurrentCamp)
		return relation_enemy;
